...
use App\User;
use App\Surat;
use App\Exports\SuratEksternalExport;
...
class SuratEksternalController extends Controller
{
    ...
    public function getSuratEksternal()
    {
        ...
        return view('user/surateksternal', compact('surat'));
    }

    public function getSuratEksternalSearch(Request $request)
    {
        $cari = $request->cari;
        $mulai = $request->mulai;
    ...
    public function showSuratEksternal($id)
    {
        $surat = DB::table('surats')
                ->join('users','surats.id_users','=','users.id_user')
                ...
                ->get();
        $user = User::all();
        return view('user/detailsurateksternal', compact('surat','user'));
    }

    public function showCreateSuratEksternal()
    {
        ...
        return view('user/addsurateksternal', compact('create_nosurat', 'user'));
    }

    public function createSuratEksternal(Request $request)
    {
        $surat = new Surat;
        ...
        $surat->save();
        return redirect('user/get-surat-eksternal');
    }
    ...
    public function csv()
    {
        ...
        $filename = "Laporan Surat Eksternal per".$time.".xlsx";
        return Excel::download(new SuratEksternalExport(), $filename);
    }

    public function downloadSuratEksternal($id)
    {
    ...
    public function showEditSuratEksternal($id)
    {
        $surat = DB::table('surats')
                    ->join('users', 'surats.id_users' ,'=', 'users.id_user')
        ...
        return view('user/editsurateksternal', compact('surat'));
    }

    public function editSuratEksternal(Request $request)
    {
        $file_surat = $request->file('filesurat');
        $nama_file = $file_surat->store('public/files');
    ...
    public function deleteSuratEksternal($id)
    {
        DB::table('surats')
            ->where('id_surat', $id)
            ->delete();
