    ...
    <div class="col-lg-12">
        <div class="page-title">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">History Surat</li>
            </ol>
        </div>
                ...
                <div class="portlet portlet-green">
                    <div class="portlet-heading">
                        <div class="portlet-title">
                            <h4><i class="fa fa-exchange fa-fw"></i>History Surat</h4>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>un read</td>
                                            <td>
                                                <a href="panel-page-profile.html"><i class="fa fa-eye mr-3"></i> History Surat</a>
                                            </td>
                                        </tr>
                                        <?php  }  ?>
                                    </tbody>
