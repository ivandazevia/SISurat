                    ...
                    <div class="portlet portlet-purple">
                        ...
                        <div id="formControls" class="panel-collapse collapse in">
                            ...
                            @foreach ($surat as $sur)                             
                                <form id="frm" action="{{URL('/user/show-surat-internal/')}}" method="post" enctype="multipart/form-data">
                                <fieldset>
                                @csrf
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <label class="control-label" style="font-weight: normal;">{{$sur->file_surat}}<a download href="{{URL('user/download-surat-internal/'.$sur->id_surat)}}">(<strong>Unduh</strong>)</a></label>
                                        </div>
                                    </div>                                                                       
                                    <fieldset>
                                </form>
